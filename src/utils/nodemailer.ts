...
const getTemplate = (name: string, randomNumber: string, device: string) => {
  if (device === "movil") {
    ...
    <a href="https://www.ejemplo.com" target="_blank" style="display:inline-block;background-color:#007bff;border-radius:5px;color:#ffffff;font-size:16px;padding:10px 20px;text-decoration:none;">Información de contacto</a>
  ...
  `;
    ...
    <a href="https://www.ejemplo.com" target="_blank" style="display:inline-block;background-color:#007bff;border-radius:5px;color:#ffffff;font-size:16px;padding:10px 20px;text-decoration:none;">Verificar cuenta</a>
    <p style="color:#000;font-size:14px;">Si tienes alguna pregunta o necesitas ayuda adicional, no dudes en ponerte en contacto con nuestro equipo de soporte a través este enlace: </p>
    <a href="https://www.ejemplo.com" target="_blank" style="display:inline-block;background-color:#007bff;border-radius:5px;color:#ffffff;font-size:16px;padding:10px 20px;text-decoration:none;">Información de contacto de soporte</a>
    <p style="color:#000;font-size:14px;">¡Esperamos verte pronto en TimeCheck y que disfrutes de una experiencia fluida y eficiente en la gestión de tus eventos!</p>
    <p style="color:#000;font-size:14px;">Atentamente</p>
    <p style="color:#000;font-size:14px;">El equipo de TimeCheck</p>
    `;
